...
{
    public class CreateModerationPostTest
    {
        private readonly ITestOutputHelper _output;

        public CreateModerationPostTest(ITestOutputHelper output)
        {
            _output = output;
        }
        ...
        public async Task UTC01_Success()
        {
            ...
            // Rest request
            var restRequest = new RestRequest("/api/Moderation/CreatePost");
            string payload = $$"""
                {
                  "title": "Hướng dẫn cài đặt môi trường",
                  "description": "Vào xem thôi",
