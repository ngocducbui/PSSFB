...
{
    public class UpdateModerationPostTest
    {
        private readonly ITestOutputHelper _output;

        public UpdateModerationPostTest(ITestOutputHelper output)
        {
            _output = output;
        }
        ...
        public async Task UTC01_Success()
        {
            ...
            // Rest request
            var restRequest = new RestRequest("/api/Moderation/UpdatePost");
            string payload = $$"""
                {
                  "id": 8,
                  "title": "Hướng dẫn này đã được sửa",
            ...
            restRequest.AddQueryParameter("id", "8");
